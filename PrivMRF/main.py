...
def run(data, domain, attr_hierarchy, exp_name, epsilon, task='TVD', p_config=None):
    ...
    gpu = False
    if config['data'] == 'adult' or config['data'] == 'br2000' or config['data'] == 'mock_adult_raw' or config['data'] == 'mock_adult' or config['data'] == 'covertype' or config['data'] == 'bean_data' or config['data'] == 'Magic_Gamma_telescope' or config['data'] == 'Sensorless_drive_diagnosis' or config['data'] == 'avila_combined_df':
        gpu = True
